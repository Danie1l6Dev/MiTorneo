...
<div {{ $attributes->class('flex flex-col items-center justify-center gap-3 rounded-xl border border-dashed border-zinc-300 px-6 py-10 text-center dark:border-white/15') }}>
